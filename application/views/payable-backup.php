            ...
            <div class="col-md-12">
                ...
                <div class="card-body">
                  <div class="material-datatables">
                    <table class="table" id="datatables">
                      ...
                      <tbody>
                        <?php $id=1; foreach ($dailytrip_commission_details_payable as $results) { ?>
                        <tr> 
                          ...
                          <td><?php 
                             $a = $this->main_model->get_dailytrip_commission_payable_after_paid_amount($results->trapdid);
                             if($a==null){
                              echo 'All Pending';
                             }else if($a<0){
                              echo $a;
                ...
                <div class="card-body">
                  <div class="material-datatables">
                    <table class="table" id="datatables1">
                      ...
                      <tbody>
                        <?php $id=1; foreach ($tripsummary_payable as $results) { ?>
                        <tr>
                          <td class="text-center"><?php echo $id; ?></td>
                          <td><?php echo $results->trapdname; ?></td>
                          ...
                          <td><?php echo $results->trapddate; ?></td>
                          <td><?php 
                             $a = $this->main_model->get_tripdetil_payable_after_paid_amount($results->trapdid);
                ...
                <div class="card-body">
                  <div class="material-datatables">
                    <table class="table" id="datatables6">
                      ...
                      <tbody>
                        <?php  $id=1; foreach ($othermaterial_payable as $results) { ?>
                        <tr>
                          <td class="text-center"><?php echo $id; ?></td>
                          <td><?php echo $results->trapdname; ?></td>
                          ...
                          <td><?php echo $results->trapddate; ?></td>
                          <td><?php 
                             $a = $this->main_model->get_otheramount_payable_after_paid_amount($results->trapdid);
                ...
                <div class="card-body">
                  <div class="material-datatables">
                    <table class="table" id="datatables3">
                      ...
                      <tbody>
                        <?php  $id=1; foreach ($returntrip_payable as $results) { ?>
                        <tr>
                          <td class="text-center"><?php echo $id; ?></td>
                          <td><?php echo $results->trapdname; ?></td>
                          ...
                          <td>
                          <?php 
                             $a = $this->main_model->get_returntrip_payable_after_paid_amount($results->trapdid);
                           ...
                           ?></td>
                          <td class="td-actions text-right">
                            <a href="<?php echo base_url()?>main/payablereportview/5/<?php echo $results->trapdid ;?>" rel="tooltip" class="btn btn-success">
                              <i class="material-icons">remove_red_eye</i>
                            </a> 
                            <a href="" rel="tooltip" class="btn btn-danger">
                              <i class="material-icons">delete</i>
              ...
              <div class="card">
                <div class="card-header card-header-rose card-header-icon">
                  ...
                  <h4 class="card-title">Pump Details </h4>
                </div>
                <div class="card-body">
                  <div class="material-datatables">
                    <table class="table" id="datatables3">
                      ...
                      <tbody>
                        <?php  $id=1; foreach ($pump_payable_details as $results) { ?>
                        <tr>
                          <td class="text-center"><?php echo $id; ?></td>
                          <td><?php echo $results->tnumber; ?></td>
                          <td><?php echo $results->tpname; ?></td>
                          <td><?php echo $results->tpdamount; ?></td>
                          <td><?php echo $results->tpdpaidamount; ?></td>
                          <td><?php echo $results->remaining; ?></td>
                          
                          <td class="td-actions text-right">
                            <a href="#" rel="tooltip" class="btn btn-success get_truck_maintain">
                            
                              <i class="material-icons">remove_red_eye</i>
                            </a> 
                            <input type="hidden" name="" value="<?php echo $results->tpdid;?>">
                            <a href="" rel="tooltip" class="btn btn-danger">
                              <i class="material-icons">delete</i>
                            </a>
                          </td>
              ...
              <div class="card">
                <div class="card-header card-header-rose card-header-icon">
                  ...
                  <h4 class="card-title">Tyre And Oil Details</h4>
                </div>
                <div class="card-body">
                  <div class="material-datatables">
                    <table class="table" id="datatables3">
                      ...
                      <tbody>
                        <?php  $id=1; foreach ($get_all_truck_maintainance as $results) { ?>
                        <tr>
                          <td class="text-center"><?php echo $id; ?></td>
                          <td><?php echo $results->tnumber; ?></td>
                          <td><?php echo $results->tname; ?></td>
                          <td><?php echo $results->tsname==''?'No Shop':$results->tsname; ?></td>
                          <td><?php echo $results->ttname==''?'No Tyre Change':$results->ttname; ?></td>
                          <td><?php echo $results->toname==''?'No Oil Change':$results->toname; ?></td>
                          <td><?php echo $results->tmodescripiton==''?'No Other Work':$results->tmodescripiton; ?></td>
                          
                          <td class="td-actions text-right">
                            <a data-toggle="modal" href="#modal-id" rel="tooltip" class="btn btn-success get_truck_maintain">
                            
                              <i class="material-icons">remove_red_eye</i>
                            </a> 
                            <input type="hidden" name="" value="<?php echo $results->tmid;?>">
                            <a href="" rel="tooltip" class="btn btn-danger">
                              <i class="material-icons">delete</i>
                            </a>
                          </td>
