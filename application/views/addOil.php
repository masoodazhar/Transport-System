          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="card ">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    <input type="text" class="form-control topricegallon" name="topricegallon" placeholder="Price per Gallon or Drum" readonly="readonly" value="<?php echo set_value('topricegallon'); ?>" >
                  </div>
                </div>
                </div>
