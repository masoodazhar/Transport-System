...
class PendingClosed_model extends base_model
{
    ...
    public function get_all_closed_amount_by_station_full_details_payable($stationid){
        ...
        tremainingamountpersondetailclosed.trapdcdescription FROM tremainingamountpersondetailclosed WHERE tremainingamountpersondetailclosed.tableid<>'ttruck' and tremainingamountpersondetailclosed.tabletype='p' AND tremainingamountpersondetailclosed.trapdid=".$stationid."");
        
        return $data->result();

    }
    public function get_payable_from_all_table_on_truck_id($stationid, $truckid){
        $data = $this->db->query("SELECT
    ...
    public function get_sumof_all_table_closed_amount_by_truck_and_station_id_payable($stationid,$truckid){

        $data = $this->db->query("SELECT IFNULL(SUM(tremainingamountpersondetailclosed.trapdcamount),0) as get_sumof_closed_amount_by_personid  FROM tremainingamountpersondetailclosed WHERE tremainingamountpersondetailclosed.trapdid=".$stationid." AND tremainingamountpersondetailclosed.tableid='".$truckid."'  AND tabletype='p'");
        return $data->row('get_sumof_closed_amount_by_personid');
    ...
    public function get_payable_on_truck($stationid, $truckid){
    ...
    public function get_sumof_closed_amount_by_personid($trapdid){
        ...
        $data = $this->db->query("SELECT tremainingamountpersondetail.trapdamount as totalamount, SUM(tremainingamountpersondetailclosed.trapdcamount) AS paidamount, SUM(tremainingamountpersondetailclosed.trapdcamount)+tremainingamountpersondetail.trapdamount AS remainingamount , tremainingamountpersondetail.trapdid,  tremainingamountpersondetail.trapdname, tremainingamountpersondetail.trapdamount FROM tremainingamountpersondetailclosed INNER JOIN tremainingamountpersondetail ON tremainingamountpersondetail.trapdid=tremainingamountpersondetailclosed.trapdid AND tremainingamountpersondetail.trapdamount<0 AND tremainingamountpersondetail.trapdid=".$trapdid."");
        return $data->row();

    }

    public function get_detail_trip_explode_of_trucks_tdailytrip($stationid, $truckid, $table){
       
    }
    public function get_detail_trip_explode_of_trucks_ttripdetail($stationid, $truckid, $table){
        
    }
    public function get_detail_trip_explode_of_trucks_tothermaterial($stationid, $truckid, $table){
        
    }
    public function get_detail_trip_explode_of_trucks_treturntrip($stationid, $truckid, $table){
